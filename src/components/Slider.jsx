          ...
          >
            <swiper-slide>
              <div className="flex flex-col gap-y-2 md:gap-y-8 justify-center items-center h-full px-4 lg:px-20 text-center bg-[#000000B3] rounded-xl">
                <h1 className="text-xl font-bold text-yellow-500 md:text-2xl lg:text-3xl font-merriweather">
                  Luxury is a lifestyle.<br></br>Not just a possession.
                </h1>
                <p className="px-6 text-white md:px-10">
                  Indulge in luxury living with LuxeLife Estates. Discover a
                  world where every detail speaks volumes and every home is a
            ...
            <swiper-slide>
              <div className="flex flex-col gap-y-2 md:gap-y-8 justify-center items-center h-full px-4 lg:px-20 text-center bg-[#000000B3] rounded-xl">
                ...
                <p className="px-6 text-white md:px-10">
                  LuxeLife Estates unveils the epitome of refined living with
                  our exclusive collection of prestigious properties. Explore
                  our curated selection of luxurious villas, estates, and
                  residences.
                </p>
              </div>
            </swiper-slide>
            ...
            <swiper-slide>
              <div className="flex flex-col gap-y-2 md:gap-y-8 justify-center items-center h-full px-4 lg:px-20 text-center bg-[#000000B3] rounded-xl">
                ...
                <p className="px-6 text-white md:px-10">
                  Experience the pinnacle of luxury living with LuxeLife
                  Estates. Immerse yourself in unparalleled comfort and
                  sophistication as you explore our exclusive collection of
                  properties. From lavish villas to opulent estates, each
                  residence is designed to redefine your idea of luxury.
                </p>
              </div>
            </swiper-slide>
          </swiper-container>
